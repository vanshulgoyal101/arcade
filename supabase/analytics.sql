...
create trigger arcade_events_guard
  before insert on public.arcade_events
  for each row execute function public.arcade_events_guard();
...
revoke execute on function public.arcade_stats(int) from public, anon;
